...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            <a href="./iniciarsesion.html" class="nav-item nav-link">Iniciar sesión</a>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0"><a href="./tienda.php">Inicio</a></p>
                <p class="m-0 px-2">-</p>
    ...
    <?php
    // Obtener los productos de la base de datos y mostrarlos
    ...
    while ($producto = $result->fetch_assoc()) {
        ...
        echo '<p>Género: ' . $producto['genero'] . '</p>';
        echo '<form method="post">';
        echo '<input type="hidden" name="id_producto" value="' . $producto['producto_id'] . '">';
